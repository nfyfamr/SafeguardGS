# Codes from Compact 3DGS paper, https://github.com/maincold2/Compact-3DGS
...
class Compact_3DGS(GaussianModel):
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._mask], 'lr': training_args.compact_3dgs_mask_lr, "name": "mask"},
        ]
    ...
    def addtional_loss(self, opt):
        return opt.compact_3dgs_lambda_mask * torch.mean((torch.sigmoid(self._mask)))
    ...
    def prune_after_densify(self, opt, iteration, scene=None, pipe=None, background=None, render=None):
        if iteration >= opt.densify_until_iter and iteration % opt.compact_3dgs_prune_iter == 0:
            self.mask_prune()       
