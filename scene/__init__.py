...
from scene.gaussian_model_efficient_gs import EfficientGS
from scene.gaussian_model_safeguard_gs import SafeguardGaussian
...
ModelPool = {
    ...
    'rad_splat': RadSplat,
    'random': RandomPrune,
    'efficient_gs': EfficientGS,
    'safeguard_gs': SafeguardGaussian,
}